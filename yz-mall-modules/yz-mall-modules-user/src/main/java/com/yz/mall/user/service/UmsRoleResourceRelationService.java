...
public interface UmsRoleResourceRelationService {
     ...
     * @return 所有数据
     */
    TableDataInfo<UmsRoleResourceRelation> listPage(UmsRoleResourceRelation umsRoleResourceRelation, PageQuery pageQuery);
     ...
     * @return 单条数据
     */
    UmsRoleResourceRelation getInfo(Serializable id);
     ...
     * @return 新增结果
     */
    int add(UmsRoleResourceRelation umsRoleResourceRelation);
     ...
     * @return 修改结果
     */
    int edit(UmsRoleResourceRelation umsRoleResourceRelation);
