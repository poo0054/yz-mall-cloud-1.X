...
public interface UmsMemberLevelService {
     ...
     * @return 所有数据
     */
    TableDataInfo<UmsMemberLevel> listPage(UmsMemberLevel umsMemberLevel, PageQuery pageQuery);
     ...
     * @return 单条数据
     */
    UmsMemberLevel getInfo(Serializable id);
     ...
     * @return 新增结果
     */
    int add(UmsMemberLevel umsMemberLevel);
     ...
     * @return 修改结果
     */
    int edit(UmsMemberLevel umsMemberLevel);
