...
import com.yz.mall.user.mapper.UmsMemberMapper;
...
public class UmsMemberServiceImpl implements UmsMemberService {
    ...
    private final UmsMemberMapper baseMapper;
...
//                        SysLogininfor::getLoginTime, params.get("beginTime"), params.get("endTime"));
        ...
        Page<UmsMember> page = baseMapper.selectPage(pageQuery.build(), lqw);
        return TableDataInfo.build(page);
    }

    @Override
    public UmsMember getInfo(Serializable id) {
        return baseMapper.selectById(id);
    }

    @Override
    public int add(UmsMember umsMember) {
        return baseMapper.insert(umsMember);
    }

    @Override
    public int edit(UmsMember umsMember) {
        return baseMapper.updateById(umsMember);
    }
